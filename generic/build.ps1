...
foreach($osVersion in @('ltsc2022','ltsc2019')) {
    ...
    $freddyGenericImage = "freddyk/businesscentral:$osVersion-sql2019"
    docker pull $freddyGenericImage
    Write-Host "No existing freddy generic image found for $osVersion"
